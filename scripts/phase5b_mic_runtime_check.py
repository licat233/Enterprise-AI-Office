...
def check_runtime(runtime_root: Path, hermes_home: Path, vault_root: Path) -> list[str]:
    ...
    check(set(include) == {"route_work_product", "save_article_package", "save_social_package", "save_mic_product_package"}, "Operations receives the exact four-tool scoped Router allowlist", failures)
