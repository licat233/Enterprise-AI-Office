...
require_text config/capabilities.yaml 'operation-envelope-signing-key' 'EAO registry declares approval signing secret class'
...
require_text config/mcp-registry.yaml 'maintainer_allowlist:' 'MCP registry has explicit maintainer review allowlist'
