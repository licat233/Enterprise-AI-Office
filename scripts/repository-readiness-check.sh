...
require_text config/capabilities.yaml 'Open WebUI Profile connection URL/index and Model ID mappings' 'Core capability records Open WebUI runtime object mappings'
