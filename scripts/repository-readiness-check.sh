...
require_text infrastructure/hermes/PROVISIONING.md 'fail closed rather than inheriting the default/owner key' 'Hermes provisioning provenance covers Profile credential isolation'
